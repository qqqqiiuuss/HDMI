...
# ============================================================================
# TWIST-style reward aliases
# ============================================================================

# Alias for TWIST config compatibility
tracking_keybody_pos = keypoint_pos_tracking_local_product
tracking_joint_dof = joint_pos_tracking_product
tracking_joint_vel = joint_vel_tracking_product
tracking_root_pose = keypoint_ori_tracking_local_product  # Using orientation tracking for root pose
tracking_root_vel = keypoint_lin_vel_tracking_product  # Using linear velocity tracking for root velocity
